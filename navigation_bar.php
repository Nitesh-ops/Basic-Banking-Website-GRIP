...
<section class="ftco-section">
		<div class="container">
		    ...
		    <div class="container">
		    	<a class="navbar-brand" href="index.php"><span class="glyphicon glyphicon-magnet"></span>PI BANK</a>
		      ...
		      <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="newuser.php"><i class="glyphicon glyphicon-user"></i>  New User</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="transfer.php"><i class="glyphicon glyphicon-transfer"></i>  Transfer Money</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="transaction.php"><i class="glyphicon glyphicon-repeat"></i>  Transaction History</a>
                </li>
		        </ul>
		      </div>
		    </div>
